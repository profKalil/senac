...
public class Controller {
	...
	private int getNumeroDeAlunos() {
		...
		try (BufferedReader reader = new BufferedReader(
				new FileReader("C:\\Users\\professor\\Desktop\\java\\Escolha\\src\\escolha\\alunos.txt"))) {
	...
	public boolean verificarMatricula(Integer matricula) {
		...
		try (BufferedReader reader = new BufferedReader(
			...
			while ((linha = reader.readLine()) != null) {
				...
				if (matricula.toString().equals(matriculaArquivo)) {
					condicao = true;
					break;
				}
			}
